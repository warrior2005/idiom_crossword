> 2026-09-09 使用范围更新：本文仅第 4 部分的 5 条错误拼音修正作为后续开发参考，其余分析与计划忽略。难度、选词及关卡开发统一以[最新改造方案](specs/2026-09-09-difficulty-and-level-experience-redesign.md)为准。以下保留历史内容。
