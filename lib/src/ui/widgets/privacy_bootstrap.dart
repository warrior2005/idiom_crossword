                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          ...
                          '广告按 iOS 系统地区分流：中国大陆使用 Dirichlet 及穿山甲，其他地区使用 AdMob。广告 SDK 会处理设备基础信息、IP 地址、网络状态、广告互动和诊断数据，用于广告投放、效果统计和反作弊。仅在系统跟踪授权后读取 IDFA，不提供精确位置；不允许跟踪仍可请求广告。\n\n'
                          '请阅读以下完整协议，了解信息处理、保存期限、您的权利及联系方式，点击“同意”后继续使用。',
