...
- 2026-07-31: 完成三级提示系统（一字×3/关 免费、之后消耗提示卡；成语提示×1/关；全图揭示=放弃不计入通关）
...
- 2026-08-01: 二轮反馈 6 项已修：关卡选择恢复分页（仅已完成+当前关分页）；主界面改显剩余经验"xxx经验 升至 称号"；收藏页每页 30 条分页；统计改 6 卡片每行 3 个且"最近通关"左对齐；游戏页等级显示"Lv.1 童生"；完成词条区固定高度避免布局抖动。成语提示/揭示功能待与产品讨论
