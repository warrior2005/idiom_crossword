...
> 面向 iOS 的成语交叉填字游戏，Flutter 开发。截止 2026-06-14，核心引擎全部完成，数据评分 100% 完成。
...
| 模块 | 状态 | 备注 |
|------|------|------|
| Core Engine（全部 6 个） | ✅ 完成 | 已通过单元测试 |
| IntegratedGenerator | ✅ 完成 | 100% 成功率（5-8 成语） |
| 干扰字引擎 | ✅ 完成 | 形近+音近+部首 |
| 数据库 Schema | ✅ 完成 | v2 定型，database.dart 已对齐，idiom_crossword.db 已生成 |
| 数据评分 | ✅ 100% | 29502/29502，B0-B148 全部完成 |
| 游戏 UI | 🔲 骨架 | game_screen.dart 仅框架 |
| 关卡生成 | 🔲 待接入 | 引擎已有，待接入 UI |
| 状态管理 | 🔲 待建设 | src/state/ 目录为空 |
| 本地存储 | 🔲 待建设 | 关卡进度、用户数据 |
| iOS 构建验证 | 🔲 待验证 | |
