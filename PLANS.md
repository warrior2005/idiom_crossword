...
## 下一轮执行计划：四档词汇与全智能主线（2026-09-11）

[执行计划与验收标准](docs/specs/2026-09-11-four-tier-adaptive-mainline-execution-plan.md)已整理，待用户审阅后开工。新计划明确：教材与人工标注优先，整合旧465条，新增222条，剩余词快速推断四档；所有入库词参与生成，审核状态仅作记录；移除手动三档设置，自动适配只影响后续新题；干扰字按比例生成且至少4个，复用现有消歧。

涉及冲突规则，以该执行计划为准。下方2026-09-09清单保留为已完成首版的历史记录，不代表新计划已实施。
