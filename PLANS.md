...
分析结论与方向已确认，实现待开始。开发依据见 [成语分级与关卡体验改造方案](docs/specs/2026-09-09-difficulty-and-level-experience-redesign.md)。涉及难度与选词时，以新方案为准；下文的既有完成状态不代表本次改造已完成。

- [ ] P0：入门词池审核、旧手工文档第 4 部分的 5 条拼音修正、最终成品配额及准入约束、安全回退、稳定 ID 的老用户内容更新和旧题换题。
- [ ] P1：前 20 关题面、主线候选字数量随词数及题面难度调整、解除科举等级与高难词池绑定、主线生僻度边界和观测基线。
- [ ] P2：前 200 关轻量适配、每词掌握记录、定向复习和分组评估。
